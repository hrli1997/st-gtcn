...
D_param = 19  # last valid epoch:27
G_param = D_param
...
def train(batch_count, centres, num_class, model_G, model_D, img, GRU_num_layers,
    ...
    g_optimizer = torch.optim.Adam(model_G.parameters(), lr=0.0001)
...
if __name__ == "__main__":
    ...
    model_G = Generator_net(GCN_inp_d, GCN_hid1_d, GCN_hid2_d, GCN_hid3_d, GCN_out_d,
